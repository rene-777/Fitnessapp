// Erzeugt Job-Dateien aus spec.mjs:  node scripts/kie-jobs/make.mjs start|end
...
import { MODEL, STYLE, STYLE_REFS, EXERCISES } from './spec.mjs'
...
const dir = `scripts/kie-jobs/batch-${phase}`
...
for (const e of EXERCISES) {
  ...
  const job = { model: MODEL, out: `public/img/gen/${e.key}_${phase}`, input: { prompt, input_urls: refs, aspect_ratio: '3:4', resolution: '1K' } }
